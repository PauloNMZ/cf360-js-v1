  ...
  return (
    <div className="flex justify-between items-center mb-4 p-4 bg-muted/30 rounded-lg border">
      ...
      <div className="flex gap-3 items-center">
        <Button variant="outline" onClick={onVerifyErrors} className="flex items-center">
          <FileCheck className="mr-2 h-4 w-4" />
          Verificar Erros
        </Button>

        {validationPerformed && hasValidationErrors && (
          <Button variant="outline" onClick={onExportErrors} className="flex items-center text-amber-600">
