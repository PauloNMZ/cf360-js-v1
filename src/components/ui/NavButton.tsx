...
export const NavButton = ({ icon, label, onClick, disabled = false, className = "" }: NavButtonProps) => {
  return (
    <button 
      ...
      flex flex-col items-center justify-center p-2 mx-1 ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`}
      onClick={onClick}
      disabled={disabled}
    >
