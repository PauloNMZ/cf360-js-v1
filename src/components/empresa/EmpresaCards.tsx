  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
      {convenentes.map(convenente => (
        <div
          key={convenente.id}
          className={`bg-gradient-to-br from-gray-900 to-gray-800 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6 border-2 transition-all duration-300 hover:shadow-xl hover:scale-105 cursor-pointer flex flex-col ${
        ...
        >
          ...
          <div className="flex justify-center mt-auto">
            <Button
              ...
              className="hover:opacity-90 text-white border-0 px-6 py-2 text-xs font-medium transition-all"
              onClick={(e) => {
                e.stopPropagation();
