...
const FavorecidosTableRow: React.FC<FavorecidosTableRowProps> = ({
  ...
  return <TableRow key={favorecido.id} onClick={() => onSelectFavorecido && !showActions && onSelectFavorecido(favorecido)} className={cn(onSelectFavorecido && !showActions && "cursor-pointer hover:bg-muted/50")}>
